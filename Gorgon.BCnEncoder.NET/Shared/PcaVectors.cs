...
internal static class PcaVectors
{
        ...
        float rWeight = 0.3f, float gWeight = 0.6f, float bWeight = 0.1f)
    {
        ...
        void Clamp565(ref Vector3 vec)
        {
            ...
            vec = new Vector3((float)System.Math.Round(vec.X), (float)System.Math.Round(vec.Y), (float)System.Math.Round(vec.Z));
        }
        ...
        endPoint0 = new Vector3((float)System.Math.Round(endPoint0.X * 31), (float)System.Math.Round(endPoint0.Y * 63), (float)System.Math.Round(endPoint0.Z * 31));
        endPoint1 = new Vector3((float)System.Math.Round(endPoint1.X * 31), (float)System.Math.Round(endPoint1.Y * 63), (float)System.Math.Round(endPoint1.Z * 31));
